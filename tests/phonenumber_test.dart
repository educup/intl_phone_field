...
void main() {
  group('PhoneNumber', () {
    test('create a phone number', () {
      ...
      final String actual = phoneNumber.completeNumber;
      const String expected = '+447891234567';
    ...
    test('create a Guernsey number', () {
      ...
      final String actual = phoneNumber.completeNumber;
      const String expected = '+441481960194';
    ...
    test('look up UK as a country code', () {
      final Country country = PhoneNumber.getCountry('+447891234567');
    ...
    test('look up Guernsey as a country code', () {
      final Country country = PhoneNumber.getCountry('+441481960194');
